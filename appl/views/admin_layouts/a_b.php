        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="page-header">
                    <div class="row">
                        <div class="col-sm-6">
                            <i class="fa fa-plus-circle" aria-hidden="true"></i> Post <small>(New Blog)</small>
                        </div>
                    </div>
                </h1>
                <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <?php
                    ...
                    echo form_open_multipart('admin/add_blog_validation', $attributes);
                ?>
                    ...
                    <div class="form-group">
                        <label>Featured-Image (Max: 200 x 170)</label>
